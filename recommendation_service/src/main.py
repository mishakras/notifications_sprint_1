...
from recommendation_service.src.api.recomendation.v1 import recommendations
from recommendation_service.src.core import settings
from recommendation_service.src.db import elastic, beanie
from recommendation_service.src.models.video_completion import VideoCompletionDB
