...
from recommendation_service.src.services.movies.films import get_film_service
from recommendation_service.src.services.recomendation_service import get_recommendation_service
...
async def test_get_by_id(
    ...
    history_data = await recommendation_service.get_history(query_data["user_id"])
...
@pytest.mark.parametrize(
    ...
    [
        (
                ...
                {"len": 2, "first_id": '88f2ec42-6cf4-4e2d-a52b-a2e33b7e739d'},
        ),
        (
                {'user_id': ['db42c73d-fb40-4b56-a34c-7dce78e95412']},
                {"len": 0},
