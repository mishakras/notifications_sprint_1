...
from recommendation_service.src.schemas.mixin import (
    DescriptionMixin,
    IdMixin,
    RatingMixin,
    TitleMixin,
...
from recommendation_service.src.schemas.movies.genres import Genre, ResponseGenreData
from recommendation_service.src.schemas.movies.persons import (
    Person,
    ResponsePersonData,
)
